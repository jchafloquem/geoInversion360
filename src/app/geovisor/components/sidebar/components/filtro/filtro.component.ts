...
export class FiltroComponent implements OnInit {
	...
	public regionFeatureLayer!: FeatureLayer;
	public provinciaFeatureLayer!: FeatureLayer;
	public distritoFeatureLayer!: FeatureLayer;
	public regionDarkBackLayer!: FeatureLayer;
	public provinciaDarkBackLayer!: FeatureLayer;
	public distritoDarkBackLayer!: FeatureLayer;
		...
		this.regionDarkBackLayer = new FeatureLayer({
			...
			renderer: new SimpleRenderer({
				symbol: new SimpleFillSymbol({
					color: new Color([0, 0, 0, 0.9]), // Color de fondo oscuro
					outline: {
	...
	provinciaDarkBlack(): void {
		this.provinciaDarkBackLayer = new FeatureLayer({
			...
			minScale: 0, // Visible en todas las escalas
			maxScale: 0,
			labelsVisible:false, // Visible en todas las escalas
		});
